...
#define debugType "t'go.debug#debugger'"
  ...
  escape(exit,0,True,False,"F1iv","terminate go engine")
  ...
  escape(_unify,4,False,False,":k't'P2k't'k't'","unification")
  escape(_identical,5,False,False,":k't'P2k't'k't'","test for identicality")
  escape(_match,6,False,False,":k't'P2k't'k't'","matching")

  escape(var,7,False,False,":k't'P1k't'","test for variable")
  escape(nonvar,8,False,False,":k't'P1k't'","test for non-variable")

  // escape(_call,11,True,False,"p4+s+s+i+LS","dynamic call")

  // escape(_defined,12,True,False,"P3+s+s+i","test for defined name")

escape(_int_plus,13,False,False,"F2iii","add two integers")
escape(_int_minus,14,False,False,"F2iii","subtract two integers")
escape(_int_times,15,False,False,"F2iii","multiply two integers")
escape(_int_div,16,False,False,"F2iii","divide two integers")
escape(_flt_plus,13,False,False,"F2fff","add two floats")
escape(_flt_minus,14,False,False,"F2fff","subtract two floats")
escape(_flt_times,15,False,False,"F2fff","multiply two floats")
escape(_flt_div,16,False,False,"F2fff","divide two floats")
escape(_int_abs,24,False,False,"F1ii","integer absolute value")
escape(_flt_abs,24,False,False,"F1ff","float absolute value")
...
*/
 // Character class escapes
  ...
  escape(_isCcChar,180,False,False,"P1i","is Other, control char")
  escape(_isCfChar,181,False,False,"P1i","is Other, format char")
  escape(_isCnChar,182,False,False,"P1i","is Other, unassigned char")
  escape(_isCoChar,183,False,False,"P1i","is Other, private char")
  escape(_isCsChar,184,False,False,"P1i","is Other, surrogate char")
  escape(_isLlChar,185,False,False,"P1i","is Letter, lowercase char")
  escape(_isLmChar,186,False,False,"P1i","is Letter, modifier char")
  escape(_isLoChar,187,False,False,"P1i","is Letter, other char")
  escape(_isLtChar,188,False,False,"P1i","is Letter, title char")
  escape(_isLuChar,189,False,False,"P1i","is Letter, uppercase char")
  escape(_isMcChar,190,False,False,"P1i","is Mark, spacing char")
  escape(_isMeChar,191,False,False,"P1i","is Mark, enclosing char")
  escape(_isMnChar,192,False,False,"P1i","is Mark, nonspacing char")
  escape(_isNdChar,193,False,False,"P1i","is Number, decimal digit")
  escape(_isNlChar,194,False,False,"P1i","is Number, letter char")
  escape(_isNoChar,195,False,False,"P1i","is Number, other char")
  escape(_isPcChar,196,False,False,"P1i","is Punctuation, connector")
  escape(_isPdChar,197,False,False,"P1i","is Punctuation, dash char")
  escape(_isPeChar,198,False,False,"P1i","is Punctuation, close char")
  escape(_isPfChar,199,False,False,"P1i","is Punctuation, final quote")
  escape(_isPiChar,200,False,False,"P1i","is Punctuation, initial quote")
  escape(_isPoChar,201,False,False,"P1i","is Punctuation, other char")
  escape(_isPsChar,202,False,False,"P1i","is Punctuation, open char")
  escape(_isScChar,203,False,False,"P1i","is Symbol, currency char")
  escape(_isSkChar,204,False,False,"P1i","is Symbol, modifier char")
  escape(_isSmChar,205,False,False,"P1i","is Symbol, math char")
  escape(_isSoChar,206,False,False,"P1i","is Symbol, other char")
  escape(_isZlChar,207,False,False,"P1i","is Separator, line char")
  escape(_isZpChar,208,False,False,"P1i","is Separator, para char")
  escape(_isZsChar,209,False,False,"P1i","is Separator, space char")

  escape(_isLetterChar,210,False,False,"P1i","is letter char")
  escape(_digitCode,211,False,False,"F1ii","convert char to num")

// String and symbol handling escapes
  escape(_int2str,214,False,False,"F4iiiiS","format an integer as a string")
  escape(_flt2str,215,False,False,"F5fiillS","format a floating as a string")
/*
