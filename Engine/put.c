...
/* Construct a executable copy of a term
   ...
   of the term
*/
retCode g__term(processPo P, ptrPo a) {
...
retCode g__remove(processPo P, ptrPo a) {
 ...
 */
retCode g__assert(processPo P, ptrPo a) {
...
retCode g__retract(processPo P, ptrPo a) {
  ptrI pr = deRefI(&a[1]);    /* The name of the program */
 ...
 * }
 */
retCode g__newObject(processPo P, ptrPo a) {
  ptrI T = deRefI(&a[1]);
