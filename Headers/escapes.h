...
#define tplType "U'#,'\2"
 ...
 // escape(_delProp,83,False,False,":\1AP\2+"thingType"+s","delete a property from a symbol")
  ...
  escape(_outch,128,True,False,"p\2+O+c","write a single character")
...
/* Timing and delaying */
 ...
 /* Character class escapes */
  ...
  escape(_isCcChar,180,False,False,"P\1+c","is Other, control char")
  escape(_isCfChar,181,False,False,"P\1+c","is Other, format char")
  escape(_isCnChar,182,False,False,"P\1+c","is Other, unassigned char")
  escape(_isCoChar,183,False,False,"P\1+c","is Other, private char")
  escape(_isCsChar,184,False,False,"P\1+c","is Other, surrogate char")
  escape(_isLlChar,185,False,False,"P\1+c","is Letter, lowercase char")
  escape(_isLmChar,186,False,False,"P\1+c","is Letter, modifier char")
  escape(_isLoChar,187,False,False,"P\1+c","is Letter, other char")
  escape(_isLtChar,188,False,False,"P\1+c","is Letter, title char")
  escape(_isLuChar,189,False,False,"P\1+c","is Letter, uppercase char")
  escape(_isMcChar,190,False,False,"P\1+c","is Mark, spacing char")
  escape(_isMeChar,191,False,False,"P\1+c","is Mark, enclosing char")
  escape(_isMnChar,192,False,False,"P\1+c","is Mark, nonspacing char")
  escape(_isNdChar,193,False,False,"P\1+c","is Number, decimal digit")
  escape(_isNlChar,194,False,False,"P\1+c","is Number, letter char")
  escape(_isNoChar,195,False,False,"P\1+c","is Number, other char")
  escape(_isPcChar,196,False,False,"P\1+c","is Punctuation, connector")
  escape(_isPdChar,197,False,False,"P\1+c","is Punctuation, dash char")
  escape(_isPeChar,198,False,False,"P\1+c","is Punctuation, close char")
  escape(_isPfChar,199,False,False,"P\1+c","is Punctuation, final quote")
  escape(_isPiChar,200,False,False,"P\1+c","is Punctuation, initial quote")
  escape(_isPoChar,201,False,False,"P\1+c","is Punctuation, other char")
  escape(_isPsChar,202,False,False,"P\1+c","is Punctuation, open char")
  escape(_isScChar,203,False,False,"P\1+c","is Symbol, currency char")
  escape(_isSkChar,204,False,False,"P\1+c","is Symbol, modifier char")
  escape(_isSmChar,205,False,False,"P\1+c","is Symbol, math char")
  escape(_isSoChar,206,False,False,"P\1+c","is Symbol, other char")
  escape(_isZlChar,207,False,False,"P\1+c","is Separator, line char")
  escape(_isZpChar,208,False,False,"P\1+c","is Separator, para char")
  escape(_isZsChar,209,False,False,"P\1+c","is Separator, space char")

  escape(_isLetterChar,210,False,False,"P\1+c","is letter char")
  escape(_digitCode,211,False,False,"F\1+ci","convert char to num")
  escape(_charOf,212,False,False,"F\1+ic","convert num to char")
  escape(_charCode,213,False,False,"F\1+ci","convert char to code")
  escape(_succChar,221,False,False,"F\2+c+ic","next character along")

/* String and symbol handling escapes */
  escape(int2str,214,False,False,"F\4+i+N+N+cS","format an integer as a string")
